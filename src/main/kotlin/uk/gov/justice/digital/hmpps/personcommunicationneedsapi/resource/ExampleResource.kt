package uk.gov.justice.digital.hmpps.personcommunicationneedsapi.resource
...
import uk.gov.justice.digital.hmpps.personcommunicationneedsapi.service.ExampleApiService
...
class ExampleResource(private val exampleApiService: ExampleApiService) {
  ...
  @Operation(
    ...
    security = [SecurityRequirement(name = "person-communication-needs-api-ui-role")],
    responses = [
